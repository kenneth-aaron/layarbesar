		...
		if ( have_comments() ) : ?>
			...
			<?php
				...
				if ( 1 == $comments_number ) {
					...
					printf( __( 'One thought on &ldquo;%s&rdquo;', 'muvipro' ), get_the_title() );
				} else {
					printf(	__(	'%1$s thoughts on &ldquo;%2$s&rdquo;', 'muvipro' ),	number_format_i18n( $comments_number ),	get_the_title()	);
				}
			?>
			</h2>
