			...
			if ( class_exists( 'WooCommerce' ) ) {
				...
				$items .= '<li class="' . esc_attr( $css_class ) . '">';
					$items .= '<a class="cart-contents" href="' . esc_url( wc_get_cart_url() ) . '">';
						$items .= '<span class="icon_cart_alt"></span><sup>' .  wp_kses_data( sprintf( _n( '%d', '%d', WC()->cart->get_cart_contents_count(), 'muvipro' ), WC()->cart->get_cart_contents_count() ) ) . '</sup>';
					$items .= '</a>';
				$items .= '</li>';
			}
			// Easy Digital Downloads
				...
				$items .= '<li class="' . esc_attr( $css_class ) . '">';
					$items .= '<a class="cart-contents" href="' . esc_url( edd_get_checkout_uri() ) . '">';
						$items .= '<span class="icon_cart_alt"></span><sup>' .  wp_kses_data( sprintf( _n( '%d', '%d', edd_get_cart_quantity(), 'muvipro' ), edd_get_cart_quantity() ) ) . '</sup>';
					$items .= '</a>';
				$items .= '</li>';
			}
		}
