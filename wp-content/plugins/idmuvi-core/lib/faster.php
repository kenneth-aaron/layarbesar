...
function idmuvi_remove_script_version( $src ) {
	...
	if ( isset( $idmuv_other['other_remove_script_version'] ) && ! empty( $idmuv_other['other_remove_script_version'] ) ) {
		// option, section, default.
...
function idmuvi_core_disable_embeds_init() {
	...
	if ( isset( $idmuv_other['other_remove_oembed'] ) && ! empty( $idmuv_other['other_remove_oembed'] ) ) {
		// option, section, default.
...
function idmuvi_core_dequeue_jquery_migrate( $scripts ) {
	if ( ! is_admin() && ! empty( $scripts->registered['jquery'] ) ) {
		...
		if ( isset( $idmuv_other['other_remove_jquery_migrate'] ) && ! empty( $idmuv_other['other_remove_jquery_migrate'] ) ) {
			// option, section, default.
