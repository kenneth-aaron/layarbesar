...
class Idmuvi_Core_Metabox_Settings_TvShow {
	...
	public function save( $post_id, $post ) {
		...
		if ( !isset( $_POST['idmuvi_core_tv_meta_nonce'] ) || !wp_verify_nonce( $_POST['idmuvi_core_tv_meta_nonce'], basename( __FILE__ ) ) )
			return $post_id;
		...
		<div id="col-container">
			<div class="metabox-holder idmuvi-core-metabox-common-fields">
				...
				<h3 class="nav-tab-wrapper">
					<a class="nav-tab nav-tab-active" id="muvi-settings-tab" href="#muvi-settings"><?php _e("TV Shows Settings:" ,'idmuvi-core'); ?></a>
				</h3>
				...
				<div id="muvi-settings" class="group">
					...
					<p>
						...
						<span class="howto"><?php echo __( 'Please insert id tmdb.<br/>Example link from tmdb https://www.themoviedb.org/tv/<strong>30991</strong>-cowboy-bebop (Just insert with <strong>30991</strong>).', 'idmuvi-core' ); ?></span>
					</p>
					...
					<p>
						<label for="opsi-title"><strong><?php _e("Original Name (TMDB):" ,'idmuvi-core'); ?></strong></label>
					...
					<p>
						<label for="opsi-release"><strong><?php _e("Relase Date (TMDB):" ,'idmuvi-core'); ?></strong></label>
					...
					<p>
						<label for="opsi-air"><strong><?php _e("Last Air Date (TMDB):" ,'idmuvi-core'); ?></strong></label>
					...
					<p>
						<label for="opsi-episode"><strong><?php _e("Number Of Episode (TMDB):" ,'idmuvi-core'); ?></strong></label>
