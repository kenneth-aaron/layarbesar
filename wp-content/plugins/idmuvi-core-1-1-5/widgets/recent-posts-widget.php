...
class Idmuvi_RPSP_form extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 'classname' => 'idmuvi-rp-widget', 'description' => __( 'Recent movies with thumbnails widget.','idmuvi-core' ) );
    ...
    public function widget($args, $instance) {
		...
		// filter the arguments for the Recent Movies widget:
    ...
    public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('idmuv_orderby'); ?>"><?php _e( 'Orderby','idmuvi-core' ); ?></label> 
            <select class="widefat" id="<?php echo $this->get_field_id('idmuv_orderby','idmuvi-core' ); ?>" name="<?php echo $this->get_field_name('idmuv_orderby'); ?>">
				<option value="date" <?php echo selected( $instance['idmuv_orderby'], 'date', false ); ?>><?php _e( 'Date','idmuvi-core' ); ?></option>
				<option value="rand" <?php echo selected( $instance['idmuv_orderby'], 'rand', false ); ?>><?php _e( 'Random','idmuvi-core' ); ?></option>
				<option value="modified" <?php echo selected( $instance['idmuv_orderby'], 'modified', false ); ?>><?php _e( 'Modified','idmuvi-core' ); ?></option>
            </select>
		</p>
		<p>
